			...
			data.students.forEach((student) => {
				...
				if (student.isActive) {
					if (student.didComplete) {
						ul.append('<li id="student" classId ="'+student.classId+'" studentId ="'+student.studentId+'" onclick="selectStudent(this)">'+
                                    student.username
                            +'<div class="student-icons"><img src="../img/completed.png" class="" alt="Completed"/><div 										class="green-dot" id="'+student.username+'"></div></li>'); 
					} else {
						ul.append('<li id="student" classId ="'+student.classId+'" studentId ="'+student.studentId+'"  onclick="selectStudent(this)">'+
                                    student.username
                            +'<div class="student-icons"><img src="../img/completed.png" class="hidden" alt="Completed"/><div 										class="green-dot" id="'+student.username+'"></div></li>'); 
					}
					...
					if (student.didComplete) {
						ul.append('<li id="student" classId ="'+student.classId+'" studentId ="'+student.studentId+'" onclick="selectStudent(this)">'+
                                    student.username
                            +'<div class="student-icons"><img src="../img/completed.png" class="" alt="Completed"/><div 										class="offline-circle" id="'+student.username+'"></div></li>'); 
					} else {
						ul.append('<li id="student" classId ="'+student.classId+'" studentId ="'+student.studentId+'" onclick="selectStudent(this)">'+
                                    student.username
                            +'<div class="student-icons"><img src="../img/completed.png" class="hidden" alt="Completed"/><div 										class="offline-circle" id="'+student.username+'"></div></li>'); 
					}
				}			
			});
		});
